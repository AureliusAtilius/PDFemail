...
# Create table organizing car data into a table
...
def process_data(data):
  ...
  pop_car_sales=0
  for i in years:
      if(years[i]>pop_car_sales):
        pop_car_year = i
        pop_car_sales = years[i]
  ...
  line3= "The most popular year was {} with {} sales.".format(pop_car_year,pop_car_sales) 
  pdf_lines=[line1,line2,line3]
  pdf_lines="<br/>".join(pdf_lines)
  data = cars_dict_to_table(data)
